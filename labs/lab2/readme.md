...
![image](./readme/Dynamic-Table.png)
...
![image](./readme/AmortizedAnalysis.png)

---

#### Your Task {#task}

In order to implement your own class, we are providing starter code. You will be given a [*header file*](readme/code/DynamicArray.h) (`DynamicArray.h`) and a partially-implemented [*source file*](readme/code/DynamicArray.cpp) (`DynamicArray.cpp`) for a class `DynamicArray`.
